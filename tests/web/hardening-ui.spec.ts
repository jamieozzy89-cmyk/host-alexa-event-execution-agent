...
test("core surfaces pass automated WCAG A and AA checks", async ({ page }) => {
...
test("current deterministic Host journey makes no unexpected cross-origin application requests", async ({ page }) => {
